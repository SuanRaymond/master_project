...
class passwordUpdate extends Controller
{
    ...
    public function index()
    {
        ...
        $this->system = $api_judge_services->check(['CMID', 'CPWON']);
        ...
        //需呼叫的功能
        $this->system->callFunction = 'PasswordUpdate';
        ...
        $this->system->sendParams['PasswordO']      = $this->system->passwordo;
        $this->system->sendParams['PasswordN']      = $this->system->passwordn;
