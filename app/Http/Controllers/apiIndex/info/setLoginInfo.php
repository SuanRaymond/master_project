...
namespace App\Http\Controllers\ApiIndex\info;
...
class setLoginInfo extends Controller
{
    ...
    public $system;
     ...
     /**
        ...
        1、從前端接收POST資訊，需取得：
            A：Params：加密後的資料JSON
            （{"MemberID":"會員唯一碼","LanguageID":"語言","EquipmentID":"裝置","IP":"IP"}）
            B：Sign：驗證碼
    ...
    public function index()
    {
        ...
        $this->system = $api_judge_services->check(['CMID', 'CML', 'CME', 'CMI']);
        ...
        //需呼叫的功能
        $this->system->callFunction = 'SetLoginInfo';
        ...
        $this->system->token = $this->system->result->Token;
