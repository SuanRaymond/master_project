...
class create extends Controller
{
    ...
    /**
        ...
        1、從前端接收POST資訊，需取得：
            A：Params：加密後的資料JSON
            （{"Account":"帳號","Name":"暱稱","Mail":"信箱","Password":"密碼","GroupID":"權限代碼","UpMemberID":"上層帳號"}）
            B：Sign：驗證碼
    ...
    public function index()
    {
        ...
        $this->system = $api_judge_services->check(['CMA', 'CPW', 'CMN', 'CMM', 'CMG', 'CMUID']);
        ...
        //需呼叫的功能
        $this->system->callFunction = 'Create';
        ...
        $this->system->sendParams['UpMemberID'] = $this->system->upmemberID;
        $this->system->sendParams['GroupID']    = $this->system->groupID;
        ...
        $this->system->memberID = $this->system->result->memberID;
