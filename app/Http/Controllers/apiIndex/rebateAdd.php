...
class rebateAdd extends Controller
{
    ...
    public function rebateList()
    {
        ...
        //需呼叫的功能
        $this->system->callFunction = 'RebateList';
        ...
        $this->system->rebateList = $this->system->result->RebateList;
    ...
    public function rebateAdd()
    {
        ...
        $this->system->action = '[communication]';
        //需呼叫的功能
        $this->system->callFunction = 'RebateAdd';
        $this->system->sendApiUrl   = config('app.urlMemberApi');
        $this->system->sendApiUrl   = json_decode($this->system->sendApiUrl, true);
        ...
        $this->system->sendParams                   = [];
        $this->system->sendParams['MemberID']       = $this->system->memberID;
        $this->system->sendParams['RebateType']     = $this->system->rebatetype;
